...
//            [[PFUser currentUser] saveInBackground];
            ...
            PFObject *person = [PFObject objectWithClassName:@"FacebookUser"];
            
            if(userProfile[@"birthday"]){
                person[@"birthday"] = userProfile[@"birthday"];
            }
            if(userProfile[@"facebookId"]){
                person[@"facebookID"] = userProfile[@"facebookId"];
            }
            if(userProfile[@"gender"]){
                person[@"gender"] = userProfile[@"gender"];
            }
            if(userProfile[@"location"]){
                person[@"location"] = userProfile[@"location"];
            }
            if(userProfile[@"name"]){
                person[@"name"] = userProfile[@"name"];
            }
            if(userProfile[@"relationship"]){
                person[@"relationship_status"] = userProfile[@"relationship"];
            }
